...
public class ClampEditorController implements Initializable {

    private ClampTableManager clampTableManager;
    ...
    public void setModel(ClampTableManager manager)
    {
        clampTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            clampTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            clampTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            clampTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = clampTableManager.getRow(id);
