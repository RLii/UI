...
public class FlangeEditorController implements Initializable {

    private FlangeTableManager flangeTableManager;
    ...
    public void setModel(FlangeTableManager manager)
    {
        flangeTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            flangeTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            flangeTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            flangeTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = flangeTableManager.getRow(id);
