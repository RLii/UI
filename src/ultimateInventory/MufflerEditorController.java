...
public class MufflerEditorController implements Initializable {

    private MufflerTableManager mufflerTableManager;
    ...
    public void setModel(MufflerTableManager manager)
    {
        mufflerTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            mufflerTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            mufflerTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            mufflerTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = mufflerTableManager.getRow(id);
