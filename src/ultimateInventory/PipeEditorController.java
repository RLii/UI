...
public class PipeEditorController implements Initializable {

    private PipeTableManager pipeTableManager;
    ...
    public void setModel(PipeTableManager manager)
    {
        pipeTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            pipeTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            pipeTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            pipeTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = pipeTableManager.getRow(id);
