...
public class WasherEditorController implements Initializable {

    private WasherTableManager washerTableManager;
    ...
    public void setModel(WasherTableManager manager)
    {
        washerTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            washerTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            washerTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            washerTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = washerTableManager.getRow(id);
