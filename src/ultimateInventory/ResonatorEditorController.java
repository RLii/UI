...
public class ResonatorEditorController implements Initializable {

    private ResonatorTableManager resonatorTableManager;
    ...
    public void setModel(ResonatorTableManager manager)
    {
        resonatorTableManager = manager;
        buildComBoxData();
    }
    ...
    public void delete()
    {
        try
        {
            resonatorTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = resonatorTableManager.getRow(id);
