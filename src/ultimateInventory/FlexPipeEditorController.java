...
public class FlexPipeEditorController implements Initializable {

    private FlexPipeTableManager flexPipeTableManager;
    ...
    public void setModel(FlexPipeTableManager manager)
    {
        flexPipeTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            flexPipeTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            flexPipeTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            flexPipeTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = flexPipeTableManager.getRow(id);
