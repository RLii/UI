...
public class ElbowEditorController implements Initializable {

    private ElbowTableManager elbowTableManager;
    ...
    public void setModel(ElbowTableManager manager)
    {
        elbowTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            elbowTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            elbowTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            elbowTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = elbowTableManager.getRow(id);
