...
public class TipEditorController implements Initializable {

    private TipTableManager tipTableManager;
    ...
    public void setModel(TipTableManager manager)
    {
        tipTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            tipTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            tipTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            tipTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = tipTableManager.getRow(id);
