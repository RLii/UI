...
public class BoxEditorController implements Initializable {
    ...
    private BoxTableManager boxTableManager;
    ...
    public void setModel(BoxTableManager manager)
    {
        boxTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            boxTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            boxTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            boxTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void buildComBoxData()
    {
        try
        {
            data.addAll(boxTableManager.getIdNames());
        }
        catch(SQLException e)
        {
            displayAlert("ERROR: "+e);
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = boxTableManager.getRow(id);
