...
public class NutsEditorController implements Initializable {
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            nutsTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            nutsTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            nutsTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = nutsTableManager.getRow(id);
