...
public class BoltEditorController implements Initializable {

    private BoltTableManager boltTableManager;
    ...
    public void setModel(BoltTableManager manager)
    {
        boltTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            boltTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            boltTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            boltTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = boltTableManager.getRow(id);
