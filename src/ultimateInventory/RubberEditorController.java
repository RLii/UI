...
public class RubberEditorController implements Initializable {

    private RubberTableManager rubberTableManager;
    ...
    public void setModel(RubberTableManager manager)
    {
        rubberTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            rubberTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            rubberTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            rubberTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = rubberTableManager.getRow(id);
