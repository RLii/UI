...
public class HangerEditorController implements Initializable {

    private HangerTableManager hangerTableManager;
    ...
    public void setModel(HangerTableManager manager)
    {
        hangerTableManager = manager;
        buildComBoxData();
    }
    ...
    public void add(ActionEvent actionEvent) {
        try
        {
            ...
            hangerTableManager.add(addIdText.getText(),
    ...
    public void edit()
    {
        try
        {
            ...
            hangerTableManager.edit(editCombox.getValue().toString(),
    ...
    public void delete()
    {
        try
        {
            hangerTableManager.delete(delCombox.getValue().toString());
        }
    ...
    public void updateDelLabels()
    {
        try
        {
            ...
            String [] array = hangerTableManager.getRow(id);
